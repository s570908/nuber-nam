...
import {
	getDrivers as GetNearbyDrivers,
	getRide as GetRideById,
	getRideVariables as GetRideByIdVariables,
	requestRide as RequestRide,
	requestRideVariables as RequestRideVariables,
	updateRide as UpdateRideStatus,
	updateRideVariables as UpdateRideStatusVariables
} from "../../types/api";
...
const PassengerHomeContainer: React.FC<IProps> = ({
	...
	>(GET_RIDE_BY_ID, {
		...
		onCompleted: ({ GetRideById }) => {
			const { ok:res, error, ride } = GetRideById;
			if (res && ride) {
